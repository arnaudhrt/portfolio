...
export default function About() {
  return (
    <div className="space-y-2" id="about">
      ...
      <p>
        Enjoying deep, dark, boring dance music: songs that set the pace in the first ten seconds and maintain it for the next ten minutes. Deep is a
        curation of my favorites. Soothed by the inherent energy of drum and bass—Drum has my favorites.
      </p>
    </div>
  );
}
